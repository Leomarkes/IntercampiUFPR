<!doctype html>
<!--
Website desenvolvido por Hiago William Petris e Leonardo Barbosa Marques, 
...
<body>
  <div class="container-fluid" style="margin-bottom:20px">
    <div class="row justify-content-center">
      <div class="col-12">
        <!--<img class="logo" src="https://www.ufpr.br/portalufpr/wp-content/uploads/2015/11/ufpr_1000.jpg" />-->
        <h2 class="tituloP">IntercampiUFPR</h2>
      </div>
    </div>
  </div>
  <div class="container-fluid select">
    <div class="row">
      ...
      <div class="col-2 divIconMap">
        <a id="linkMapOrig" href="#"><img id="mapOrigem" class="iconMap" src="imgs/map.png"></a>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid select2">
    <div class="row">
      ...
      <div class="col-2 divIconMap">
        <a id="linkMapDest" href="#"><img id="mapDestino" class="iconMap" src="imgs/map.png"></a>
      </div>
    </div>
  </div>
  <div class="container-fluid">
    <div class="row justify-content-center">
      <img class="indicParada" src="./imgs/stop.jpg"> <span style="font-size: 13px;">Indica que há paradas no caminho. Clique para ver os detalhes.</span>
    </div>
  </div>
  <div id="resultado">
  ...
  <div class="rodape" style="">  
    <footer>
        <p>Este site não possui vínculo direto com a UFPR. Os horários das linhas são retirados <a target="_blank" href="http://www.pra.ufpr.br/portal/centran/sobre/onibus-intercampi/">deste site</a>. Em caso de alteração, podem estar temporariamente desatualizados.</p>
      <p>Autores: Hiago William Petris e Leonardo Barbosa Marques</p>
  </footer>
</div>
